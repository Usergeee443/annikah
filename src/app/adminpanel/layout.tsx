    ...
    <div className="min-h-screen bg-[#f4f4f5]">
      <div className="mx-auto max-w-6xl px-4 py-5">
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          <Link href="/adminpanel" className="text-[16px] font-bold tracking-normal text-zinc-950">
            Admin Panel
          </Link>
          <div className="flex flex-wrap items-center gap-2">
            ...
            {session ? (
              <form action={logoutAction}>
                <span className="mr-2 hidden text-[11.5px] font-semibold text-zinc-500 sm:inline">
                  {session.username}
                ...
                <button
                  type="submit"
                  className="inline-flex h-9 items-center justify-center rounded-2xl bg-rose-50 px-3 text-[12px] font-semibold text-rose-700 ring-1 ring-rose-200 hover:bg-rose-100"
                >
                  Chiqish
                </button>
              </form>
              ...
              <Link
                ...
                className="inline-flex h-9 items-center justify-center rounded-2xl bg-zinc-950 px-3 text-[12px] font-semibold text-white ring-1 ring-black/10 hover:bg-zinc-900"
              >
                Kirish
              </Link>
            )}
