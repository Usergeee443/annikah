    ...
    return (
      <div className="grid gap-5">
        <div className="rounded-3xl border border-zinc-200/70 bg-white/80 p-6 shadow-sm backdrop-blur">
          <div className="text-[11px] font-semibold tracking-wide text-zinc-500">E’LON BERISH</div>
          <h1 className="mt-2 text-xl font-semibold tracking-normal text-zinc-950">Avval profilni yakunlang</h1>
          <p className="mt-1 max-w-2xl text-sm text-zinc-600">
            Faqat yetishmayotgan maydonlarni to‘ldiring — keyin e‘lon yaratishingiz mumkin.
          </p>
        </div>
        {profile ? (
