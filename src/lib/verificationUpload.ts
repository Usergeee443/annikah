...
export function verificationPhotoRelativePath(listingId: number, ext: string) {
...
export async function saveVerificationPhoto(listingId: number, bytes: Buffer, mime: string) {
